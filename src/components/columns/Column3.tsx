...
const CONCEPTS_HELP =
  ...
  "F1 Problem і F5 Story у v15 деактивовані: F1 на холодній Meta-аудиторії читається фір-монгерсько і ламає §11 Aggression, F5 надто часто провокує §14 Invented Specifics (вигадані персонажі чи сцени).\n" +
